...
\def \TITLE{BÁO CÁO BÀI TẬP LỚN -- HỆ THỐNG GỢI Ý TIN TỨC}
\def \AUTHOR{Nhóm 13 -- Deep Learning}
...
\graphicspath{{figures/}{../figures/}{../notebooks/03_results/figures/}} % Thư mục chứa các hình ảnh
...
\subfile{chapter/0_2_Loi_cam_on.tex}
...
% \renewcommand{\printnoidxglossaries}{DANH MỤC THUẬT NGỮ VÀ TỪ VIẾT TẮT}
...
\subfile{chapter/1_Gioi_thieu} % Phần mở đầu

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{CƠ SỞ LÝ THUYẾT}
\label{chapter:Related_works}
\subfile{chapter/2_Co_so_ly_thuyet}
